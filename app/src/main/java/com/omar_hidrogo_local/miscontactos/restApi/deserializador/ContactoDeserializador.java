package com.omar_hidrogo_local.miscontactos.restApi.deserializador;
...
import com.omar_hidrogo_local.miscontactos.restApi.JsonKeys;
...
/**
 * Created by tmhidrooma on 04/08/2017.
 */
...
public class ContactoDeserializador implements JsonDeserializer<ContactoResponse> {
    ...
    private ArrayList<Contacto> deserializarContactoDeJson(JsonArray contactoResponseData){
        ...
        //SE ACCESE AL ARREGLO DE DATA Y SE DESERIALIZA PARA OBTENER LOS DATOS NECESARIOS
